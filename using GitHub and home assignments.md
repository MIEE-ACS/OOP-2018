...
Для получения задания необходимо пройти по ссылке для получения задания (link here) и нажать кнопку "Assept this assignment"

![Получение задания](img/accept_assingment.png?raw=true "Получение задания")

После этого система создаст для вас новый репозиторий и выдаст его адрес. 

![Задание получено](img/accept_assingment.png?raw=true "Задание получено")
...
![Переход к списку коммитов](img/commit.png?raw=true "Переход к списку коммитов")
...
![Хороший годный коммит](img/commit.png?raw=true "Хороший коммит")
